         ...
         <v-dialog v-model="dialog" overlay-opacity="0.8" persistent>
            <v-card class="text-center d-flex flex-column">
               ...
               <v-card-text
                  class="d-block"
               >
               <a class="subtitle-1" href="https://adakapi.herokuapp.com" target="_blank">https://adakapi.herokuapp.com</a>
               </v-card-text>
               <v-card-text
                  ...
                  developed with Vue.js. Authentication is implemented with
                  JWT.
               </v-card-text>
               <v-card-text>
                  <a href="https://github.com/kevinmnm" target="_blank">Creator: Kevin Song</a> 
               </v-card-text>
            </v-card>
